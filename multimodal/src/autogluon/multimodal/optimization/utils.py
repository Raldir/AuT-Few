...
def get_trainable_params_efficient_finetune(
    ...
    elif efficient_finetune in [LORA, IA3, "ia3_lora", "ia3_ensemble", "lora_ensemble", "ia3_lora_ensemble"]:
        trainable_param_names.append(".*lora_*.")
    elif efficient_finetune in [LORA_BIAS, IA3_BIAS, "ia3_lora_bias", "ia3_lora_ensemble_bias"]:
        trainable_param_names.append(".*lora_*.")
        trainable_param_names.append(".*bias*.")
    elif efficient_finetune in [LORA_NORM, IA3_NORM, "ia3_lora_norm", "ia3_lora_ensemble_norm"]:
        trainable_param_names.append(".*lora_*.")
        trainable_param_names.append(".*bias*.")
        trainable_param_names.append(".*norm*.")
        trainable_param_names += norm_param_names
...
def apply_layerwise_lr_decay(
    ...
    return [list(parameter_group_names.values()), list(parameter_group_vars.values())]
